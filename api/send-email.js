export default async function handler(req, res) {
  ...
  const FROM = 'Red Rock Auto Repair <onboarding@resend.dev>';
  ...
  try {
    if (type === 'booking') {
      await sendEmail(NEIL_EMAILS, `New booking — ${customerName}`, `
        <div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px">
          ...
          <p style="color:#888;font-size:14px;margin-bottom:24px">Red Rock Auto Repair</p>
      ...
      if (customerEmail) await sendEmail(customerEmail, `Your appointment request — Red Rock Auto Repair`, `
        <div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px">
          ...
          <div style="margin-top:24px;padding:16px;background:#f7f7f5;border-radius:8px;font-size:13px;color:#555">Questions? Call us at <strong>(403) 287-1125</strong></div>
        </div>`);
    }

    if (type === 'confirmed') {
      if (!customerEmail) return res.status(200).json({ ok: true });
      await sendEmail(customerEmail, `Your appointment is confirmed — Red Rock Auto Repair`, `
        <div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px">
          ...
          <div style="margin-top:24px;padding:16px;background:#f7f7f5;border-radius:8px;font-size:13px;color:#555">Questions? Call us at <strong>(403) 287-1125</strong><br>5011A 11 St SE, Calgary, AB T2H 1M7</div>
        </div>`);
    }

    if (type === 'ready') {
      if (!customerEmail) return res.status(200).json({ ok: true });
      await sendEmail(customerEmail, `Your car is ready for pickup — Red Rock Auto Repair`, `
        <div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px">
          ...
          <div style="margin-top:24px;padding:16px;background:#f7f7f5;border-radius:8px;font-size:13px;color:#555"><strong>Red Rock Auto Repair</strong><br>5011A 11 St SE, Calgary, AB T2H 1M7<br>(403) 287-1125</div>
        </div>`);
    }
    ...
    if (type === 'quote') {
      ...
      if (customerEmail) await sendEmail(customerEmail, `Your quote request — Red Rock Auto Repair`, `
        <div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px">
          ...
          <div style="margin-top:24px;padding:16px;background:#f7f7f5;border-radius:8px;font-size:13px;color:#555">Questions? Call <strong>(403) 287-1125</strong></div>
        </div>`);
    }

    if (type === 'quote-confirmed') {
      if (!customerEmail) return res.status(200).json({ ok: true });
      await sendEmail(customerEmail, `Your quote is ready — Red Rock Auto Repair`, `
        <div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px">
          <div style="background:#111;border-radius:12px;padding:24px;text-align:center;margin-bottom:24px">
          ...
          <div style="margin-top:16px;padding:16px;background:#f7f7f5;border-radius:8px;font-size:13px;color:#555"><strong>Red Rock Auto Repair</strong><br>5011A 11 St SE, Calgary, AB T2H 1M7<br>(403) 287-1125</div>
        </div>`);
    }

    if (type === 'quote-declined') {
      if (!customerEmail) return res.status(200).json({ ok: true });
      await sendEmail(customerEmail, `Regarding your quote — Red Rock Auto Repair`, `
        <div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px">
